...
/* 
   ...
   argv[3] = ime tekstualne datoteke u koju zelimo spremiti TAU (vektor koeficijenata Householderovih reflektora)
   argv[4] = ime tekstualne datoteke u koju zelimo spremiti matricu A rekonstruiranu iz njene QR faktorizacije
*/
...
int main(int argc, char *argv[])
{
	...
	construct_A_from_QR(m, n, A, m, TAU);
